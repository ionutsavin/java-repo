...
Tours:
Vehicle: Drone 2, Assigned Clients: Client{name=Client 1, minTime=10:00, maxTime=16:00, type=REGULAR}
Vehicle: Drone 1, Assigned Clients: Client{name=Client 3, minTime=09:00, maxTime=17:00, type=PREMIUM}
Vehicle: Truck 1, Assigned Clients: Client{name=Client 2, minTime=07:30, maxTime=11:45, type=PREMIUM}
```